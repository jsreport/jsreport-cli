...
var useCustomSocketDirectory = process.env.cli_socketsDirectory != null
var ROOT_PATH = path.join(os.tmpdir(), 'jsreport')
var CLI_PATH = path.join(ROOT_PATH, 'cli')
var MAIN_SOCK_PATH = !useCustomSocketDirectory ? path.join(CLI_PATH, 'sock') : process.env.cli_socketsDirectory
