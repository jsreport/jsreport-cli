...
var startSocketServer = require(path.join(__dirname, './startSocketServer.js'))
var instanceHandler = require(path.join(__dirname, './instanceHandler.js'))

var PID = process.pid

function start () {
  var entryPointPath = yargs(process.argv.slice(2)).argv.entryPoint
  var parentSocketFile = process.argv[2]
