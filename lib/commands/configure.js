...
exports.handler = function (argv) {
  ...
  questions = [
    ...
    },
    {
      ...
      default: function () {
        return getPort().catch(function () { return 5488 })
      },
    ...
    },
    {
      ...
      default: function () {
        return getPort().catch(function () { return 5489 })
      },
      validate: function (input) {
        var valid = !isNaN(parseInt(input, 10))
    ...
    },
    {
      type: 'input',
      name: 'defaultTimeout',
      message: 'What should be the default timeout (in milliseconds) for jsreport execution (tasks, recipes)?',
      default: 10000,
      validate: function (input) {
        var valid = !isNaN(parseInt(input, 10))
  ...
  return (
    ...
    .then(function (answers) {
      ...
      config.tasks.timeout = answers.defaultTimeout
      config.phantom.timeout = answers.defaultTimeout
      config.electron.timeout = answers.defaultTimeout

      if (answers.createExamples) {
        console.log('TODO: ...decide which examples should we include...')
      }
