...
exports.handler = async (argv) => {
  ...
  if (commandOrTopic === 'config') {
    ...
    try {
      ...
      try {
        ...
        throw new Error(`Couldn't find a jsreport installation necessary to check the configuration options`)
      }
  ...
  if (!helpResult) {
    return console.log(`no information found for command or topic "${commandOrTopic}", to get the list of commands supported on your installation run "jsreport -h" and try again with a supported command or topic`)
  }
