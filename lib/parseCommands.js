...
module.exports = function parseCommands (args, cwd) {
  ...
  if (needsPassword) {
    ...
    return prompt.get([{
      ...
      startCommand(cliHandler, args, optionsForStart)
    })
  } else {
    startCommand(cliHandler, args, optionsForStart)
  }
...
function startCommand (cli, args, options) {
  var log = options.log
  ...
  .then(function (instance) {
    activateCLIAfterInit(cli, args, instance)
  })
  .catch(function (err) {
...
function activateCLIAfterInit (cli, args, instance) {
  ...
  process.nextTick(function () {
    cli.parse(args, { jsreport: instance })
  })
}
